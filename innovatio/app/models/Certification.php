...
class Certification 
{
    ...
    {
        $this->db->query('SELECT * FROM certification WHERE email = :email');
    ...
    {
        $this->db->query('INSERT INTO certification (profile_id,certName, validity,email) VALUES (:profile_id,:certName, :validity,:email)');
