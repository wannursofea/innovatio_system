						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
															...
															<div class="col-lg-8">
																...
																<div class="row">
																	...
																	<div class="col-lg-3 mb-6 mb-lg-0">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="<?php echo URLROOT; ?>/rewardnbadge/index" class="menu-link">
							...
							<div class="app-navbar flex-shrink-0">
								...
								<!--begin::New campaign-->
								<div class="app-navbar-item me-2 me-lg-5">
									<a class="btn btn-success d-flex flex-center h-35px h-lg-50px" data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">Buy Now</a>
								</div>
								<!--end::New campaign-->
								<!--begin::User menu-->
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													<img alt="Logo" src="https://sandkas.com/Innovatio/public/assets/media/avatars/300-13.jpg" />
												</div>
												<!--end::Avatar-->
												<!--begin::Username-->
