...
<html lang="en">
	...
	<head>
<base href="../../../" />
		<title>Youth Venture Data Management - Sign Up</title>
		<meta charset="utf-8" />
                                ...
                                <div id="studentFields" style="display: none;">
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <!--begin::Select-->
                                            <select name="gender" data-control="select2" data-hide-search="true" data-placeholder="Gender" class="form-select form-select-lg form-select-solid w-150px me-5" required>
                                                <option></option>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <!--begin::Select-->
                                            <select name="race" data-control="select2" data-hide-search="true" data-placeholder="Race  " class="form-select form-select-lg form-select-solid w-150px me-5" required>
                                                <option></option>
