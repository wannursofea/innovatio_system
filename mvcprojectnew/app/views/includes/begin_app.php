								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-column">
									...
									<div class="d-flex flex-stack my-10 my-lg-14">
										...
										<div class="page-title d-flex flex-column justify-content-center me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex title-custom fw-bolder fs-2hx flex-column justify-content-center my-0">Online Courses</h1>
											<!--end::Title-->
											<!--begin::Breadcrumb-->
											<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-700">Dash</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
										</div>
